...
public class CSVParser<T> {
  ...
  public CSVParser(
      Reader reader, CreatorFromRow<T> creatorFromRow, boolean hasHeaders, boolean ignoreCase) {
    this.reader = reader;
    this.creatorFromRow = creatorFromRow;
    this.hasHeaders = hasHeaders;
    this.ignoreCase = ignoreCase;
  ...
  public CSVParser(
      String filepath, CreatorFromRow<T> creatorFromRow, boolean hasHeaders, boolean ignoreCase) {
    this.filepath = filepath;
    this.creatorFromRow = creatorFromRow;
    this.hasHeaders = hasHeaders;
    this.ignoreCase = ignoreCase;
   ...
   * input: filename (string) output: List of list of strings that contain the csv data
   *
   * <p>code adapted from <a href="https://www.baeldung.com/java-csv-file-array">
   */
   ...
   */
  public List<T> parseIntoCSVRowObject(
      Reader reader, boolean hasHeaders, CreatorFromRow<T> creatorFromRow) {
    ...
    try (BufferedReader br = new BufferedReader(reader)) {
      ...
      while ((line = br.readLine()) != null) {
        ...
        | FactoryFailureException e) { // TODO: figure out what to add here for the exception
      throw new RuntimeException(e);
    }
    return rows;
  }
   ...
   *     <p>code from CSV handout example
   */
