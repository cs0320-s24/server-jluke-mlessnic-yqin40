...
public class SearchCSVHandler implements Route {
    ...
    private final List<List<String>> csvRowsAsList = new ArrayList<>(); // should this be more general?
    ...
    public Object handle(Request request, Response response) throws Exception {
        ...
        Searcher searcher = new Searcher(this.csvRowsAsList, true, false); //save hasHeaders and ignoreCase in Server
        ...
        if (queryParams.contains("find")) {
            ...
            if ((searchVal == null) || searchVal.isEmpty()) {
                ...
                return new CSVSearchSuccessResponse(searcher.search(searchVal), this.csvRowsAsList).serialize();
            }
            ...
            if (query == null || query.isEmpty()) {
                ...
                return new CSVSearchSuccessResponse(searcher.searchUsingQuery(query), this.csvRowsAsList).serialize();
            }
        } else {
            return new CSVSearchFailureResponse().serialize();
    ...
    public static class CSVSearchSuccessResponse {
        ...
        public CSVSearchSuccessResponse(List<Integer> foundRowIndices, List<List<String>> csvRowsAsList) {
