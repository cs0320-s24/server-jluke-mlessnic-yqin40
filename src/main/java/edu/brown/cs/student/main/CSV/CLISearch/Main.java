...
public final class Main {
  ...
  public List<Integer> run() {
    ...
    if (this.hasQuery) {
      ...
      if (arguments.size() > 2) {
        System.out.println(
            "ERROR: too many args for query. Make sure there are no spaces in the query");
      }
  ...
  /**
   * helper method to parse arguments for flags take args, read flags if found, return args without
   * flags as an array list
   *
