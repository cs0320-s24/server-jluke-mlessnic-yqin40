...
//    RI,White," $1,058.47 ",395773.6521, $1.00 ,75%
    ...
    public Demographic(String state, String dataType, double avgWeeklyEarnings, double numWorkers, double earningDisparity, double percentEmployed) {
        this.state = state;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.state.equals(d.state) && this.dataType.equals(d.dataType) && this.avgWeeklyEarnings.equals(d.avgWeeklyEarnings) && this.numWorkers.equals(d.numWorkers)&& this.earningDisparity.equals(earningDisparity) && this.percentEmployed.equals(d.percentEmployed)) {
            return true;
        } else {
...
class DemographicFromRow implements CreatorFromRow<Demographic> {
    ...
    public Demographic create(List<String> row) throws FactoryFailureException {
        ...
        return new Demographic(state, dataType, avgWeeklyEarnings, numWorkers, earningDisparity, percentEmployed);
        }
